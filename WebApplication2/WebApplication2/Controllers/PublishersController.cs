...
namespace WebApplication2.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Pid,Pname")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Pid,Pname")] Publisher publisher)
        {
            if (id != publisher.Pid)
            {
                return NotFound();
